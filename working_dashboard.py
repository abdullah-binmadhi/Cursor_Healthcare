#!/usr/bin/env python3
"""
Working Healthcare Dashboard
A simple dashboard that displays CSV data without template issues
"""
...
def dashboard():
    ...
    # Get recent data and handle column names properly
    recent_data = []
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="alert alert-info">
                        <h5>📈 Summary</h5>
                        <p>This dashboard shows healthcare analytics from your CSV data.</p>
                        <ul>
                            <li><strong>Total Patients:</strong> {{ total_patients }}</li>
                            <li><strong>Total Revenue:</strong> ${{ "{:,.0f}".format(total_revenue) }}</li>
                            <li><strong>Average Age:</strong> {{ avg_age }} years</li>
                            <li><strong>Average Billing:</strong> ${{ "{:,.0f}".format(avg_billing) }}</li>
                        </ul>
                    </div>
                </div>
            </div>
...
if __name__ == '__main__':
    print("Starting Working Healthcare Dashboard on http://localhost:3000")
